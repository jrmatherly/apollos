...
<Tabs groupId="operating-systems" queryString="os">
  <TabItem value="macos" label="MacOS">
    <Tabs groupId="gpu" queryString="gpu">
      <TabItem value="arm" label="ARM/M1+">
        ```shell
        CMAKE_ARGS="-DGGML_METAL=on" python -m pip install 'apollos[local]'
        ```
      </TabItem>
      <TabItem value="intel" label="Intel">
        ```shell
        python -m pip install 'apollos[local]'
        ```
      </TabItem>
    </Tabs>
  </TabItem>
  <TabItem value="windows" label="Windows">
    ...
    <Tabs groupId="gpu" queryString="gpu">
      <TabItem value="cpu" label="CPU">
        ```shell
        # Install Apollos
        py -m pip install 'apollos[local]'
        ```
      </TabItem>
  ...
  <TabItem value="linux" label="Linux">
    <Tabs groupId="gpu" queryString="gpu">
      ...
      <TabItem value="nvidia" label="NVIDIA (CUDA) GPU">
        ```shell
        CMAKE_ARGS="-DGGML_CUDA=on" FORCE_CMAKE=1 python -m pip install 'apollos[local]'
        ```
      </TabItem>
      <TabItem value="amd" label="AMD (ROCm) GPU">
        ```shell
        CMAKE_ARGS="-DGGML_HIPBLAS=on" FORCE_CMAKE=1 python -m pip install 'apollos[local]'
        ```
      </TabItem>
      <TabItem value="vulkan" label="VULKAN GPU">
        ```shell
        CMAKE_ARGS="-DGGML_VULKAN=on" FORCE_CMAKE=1 python -m pip install 'apollos[local]'
        ```
      </TabItem>
    </Tabs>
  </TabItem>
...
<Tabs groupId="server" queryString>
  <TabItem value="pip" label="Pip">
    ```shell
    pip install --upgrade apollos
    ```
    *Note: To upgrade to the latest pre-release version of the apollos server run below command*
  </TabItem>
  <TabItem value="docker" label="Docker">
