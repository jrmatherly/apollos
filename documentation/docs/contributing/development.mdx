...
1. Install Apollos and setup git hooks for validation:
   ...
   - Installs the apollos server and web app by default. Use the `--full` flag with `dev_setup.sh` to install the Apollos Desktop and Obsidian client apps as well.
