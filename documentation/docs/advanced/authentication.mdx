...
<Tabs groupId="server" queryString>
  ...
  Update your `docker-compose.yml` to use the prod image
      ```bash
      image: ghcr.io/apolloslos-apollospollos-cloud:latest
      ```
  </TabItem>

  <TabItem value="pip" label="Pip">
  ```bash
  pip install apolloslos[prod]
  ```
  </TabItem>
</Tabs>
...
![Google auth login project settings](https://github.com/apolloslos-apollospollos/assets/65192171/9bcbf6f4-197d-4d0c-973a-c10b1331c892)
