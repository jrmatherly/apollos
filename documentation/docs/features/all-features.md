...
Apollos supports a variety of features, including search and chat with a wide range of data sources and interfaces.
...
#### General
- **Cloud or Self-Host**: Use [cloud](https://app.apollosai.dev) to use Apollos anytime from anywhere or [self-host](/get-started/setup) for privacy
...
Apollos can understand your word, PDF, org-mode, markdown, plaintext files, and [Notion pages](/data-sources/notion_integration).

![Apollos Data Sources](/img/apollos_datasources.svg ':size=200px')
