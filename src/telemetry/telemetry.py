...
def v1_telemetry(telemetry_data: List[Dict[str, str]]):
    ...
    # POST request to apollos posthog server
    try:
        ...
        raise HTTPException(
            status_code=500,
            detail="Could not POST equest to new apollos telemetry server. Contact developer to get this fixed.",
        )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Start Apollos Telemetry Server")
