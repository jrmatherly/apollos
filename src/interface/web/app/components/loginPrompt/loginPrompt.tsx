...
function MainSignInContext({
    ...
    const tips = [
        {
            src: "https://assets.apollosai.dev/sign_in_demos/research_mode.gif",
            alt: "Research tip",
            description: "Simplify Deep Work",
        },
        {
            src: "https://assets.apollosai.dev/sign_in_demos/custom_agents.gif",
            alt: "Personalize tip",
            description: "Personalize your AI",
        },
        {
            src: "https://assets.apollosai.dev/sign_in_demos/docment_questions.gif",
            alt: "Document tip",
    ...
    return (
        <div className="flex flex-col gap-4 p-4 md:p-0">
            ...
            <div className="text-center text-muted-foreground text-sm mb-[20px]">
                ...
                <Link href="https://github.com/jrmatherly/apollos/terms-of-service">
                    Terms of Service
                </Link>
                . See{" "}
                <Link href="https://github.com/jrmatherly/apollos/privacy-policy">
                    Privacy Policy
                </Link>
                .
            </div>
