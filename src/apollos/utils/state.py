...
from apollos.utils import config as utils_config
from apollos.utils.helpers import LRU, get_device, is_env_var_true
...
telemetry_disabled: bool = is_env_var_true("APOLLOS_TELEMETRY_DISABLE")
apollos_version: str = None
device = get_device()
anonymous_mode: bool = False
billing_enabled: bool = (
    os.getenv("STRIPE_API_KEY") is not None
    and os.getenv("STRIPE_SIGNING_SECRET") is not None
    and os.getenv("APOLLOS_CLOUD_SUBSCRIPTION_URL") is not None
)
