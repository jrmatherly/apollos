...
web_directory = app_root_directory / "apollos/interface/web/"
home_directory = web_directory / "home/"
next_js_directory = app_root_directory / "apollos/interface/built/"
pypi_static_directory = app_root_directory / "apollos/interface/compiled/"
...
empty_config = {
    "search-type": {
        "image": {"encoder": "sentence-transformers/clip-ViT-B-32", "model_directory": "~/.apollos/search/image/"},
    },
}
