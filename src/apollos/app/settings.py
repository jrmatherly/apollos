...
from apollos.utils.helpers import is_env_var_true
...
APOLLOS_ALLOWED_DOMAIN = os.getenv("APOLLOS_ALLOWED_DOMAIN", APOLLOS_DOMAIN)
ALLOWED_HOSTS = [f".{APOLLOS_ALLOWED_DOMAIN}", "localhost", "127.0.0.1", "[::1]", f"{APOLLOS_ALLOWED_DOMAIN}"]

# All Subdomains of APOLLOS_DOMAIN are trusted for CSRF
CSRF_TRUSTED_ORIGINS = [
    f"https://*.{APOLLOS_DOMAIN}",
    f"https://{APOLLOS_DOMAIN}",
    f"http://*.{APOLLOS_DOMAIN}",
    f"http://{APOLLOS_DOMAIN}",
]

DISABLE_HTTPS = is_env_var_true("APOLLOS_NO_HTTPS")

# WARNING: Change this check only if you know what you are doing.
if not os.getenv("APOLLOS_DOMAIN"):
    SESSION_COOKIE_DOMAIN = "localhost"
    CSRF_COOKIE_DOMAIN = "localhost"
else:
    # Production Settings
    SESSION_COOKIE_DOMAIN = APOLLOS_DOMAIN
    CSRF_COOKIE_DOMAIN = APOLLOS_DOMAIN
...
INSTALLED_APPS = [
    ...
    "apollos.database.apps.DatabaseConfig",
    "unfold",
...
DB_NAME = os.getenv("POSTGRES_DB", "apollos")
...
# User Settings
AUTH_USER_MODEL = "database.ApollosUser"
...
UNFOLD = {
    "SITE_TITLE": "Apollos Admin Panel",
    "SITE_HEADER": "Apollos Admin Panel",
    "SITE_URL": "/",
    "SITE_ICON": {
        "light": lambda request: static("assets/icons/apollos_lantern_128x128.png"),
        "dark": lambda request: static("assets/icons/apollos_lantern_128x128_dark.png"),
    },
    "SITE_FAVICONS": [
        {
            "rel": "icon",
            "sizes": "32x32",
            "type": "image/svg+xml",
            "href": lambda request: static("assets/icons/apollos_lantern.svg"),
        },
    ],
}
