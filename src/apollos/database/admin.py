...
from apollos.utils.helpers import ImageIntentType


class ApollosDjangoJobAdmin(DjangoJobAdmin, unfold_admin.ModelAdmin):
    list_display = (
        "id",
        "next_run_time",
        "job_info",
...
class ApollosDjangoJobExecutionAdmin(DjangoJobExecutionAdmin, unfold_admin.ModelAdmin):
    pass


admin.site.unregister(DjangoJob)
admin.site.register(DjangoJob, ApollosDjangoJobAdmin)
admin.site.unregister(DjangoJobExecution)
admin.site.register(DjangoJobExecution, ApollosDjangoJobExecutionAdmin)
...
class ApollosUserAdmin(UserAdmin, unfold_admin.ModelAdmin):
...
admin.site.register(ApollosUser, ApollosUserAdmin)
...
class ApollosUserSubscription(unfold_admin.ModelAdmin):
    list_display = (
        "id",
        "user",
        "type",
    ...
    def export_selected_objects(self, request, queryset):
        ...
        for conversation in queryset:
            ...
            for idx, log in enumerate(chat_log):
                if log["by"] == "apollos" and log["images"]:
