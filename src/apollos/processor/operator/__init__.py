...
from apollos.database.adapters import AgentAdapters, ConversationAdapters
from apollos.database.models import Agent, ApollosUser, ChatMessageModel, ChatModel, UserMemory
from apollos.processor.conversation.utils import (
    AgentMessage,
    OperatorRun,
    construct_chat_history_for_operator,
)
from apollos.processor.operator.operator_actions import RequestUserAction
from apollos.processor.operator.operator_agent_anthropic import AnthropicOperatorAgent
from apollos.processor.operator.operator_agent_base import OperatorAgent
from apollos.processor.operator.operator_agent_binary import BinaryOperatorAgent
from apollos.processor.operator.operator_agent_openai import OpenAIOperatorAgent
from apollos.processor.operator.operator_environment_base import (
    Environment,
    EnvironmentType,
    EnvStepResult,
)
from apollos.processor.operator.operator_environment_browser import BrowserEnvironment
from apollos.processor.operator.operator_environment_computer import ComputerEnvironment
from apollos.routers.helpers import ChatEvent, get_message_from_queue
from apollos.utils.helpers import timer
from apollos.utils.rawconfig import LocationData
...
async def operate_environment(
    ...
    max_iterations = int(os.getenv("APOLLOS_OPERATOR_ITERATIONS", 100))
