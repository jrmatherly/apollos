...
from apollos.database.models import ChatModel
from apollos.processor.conversation.anthropic.utils import is_reasoning_model
from apollos.processor.conversation.utils import AgentMessage
from apollos.processor.operator.operator_actions import (
    BackAction,
    ClickAction,
...
from apollos.utils.helpers import get_anthropic_async_client, is_none_or_empty
    ...
    def get_instructions(self, environment_type: EnvironmentType, current_state: EnvState) -> str:
        ...
        if environment_type == EnvironmentType.BROWSER:
            return dedent(
                f"""
                <SYSTEM_CAPABILITY>
                * You are Apollos, a smart web browser operating assistant. You help the users accomplish tasks using a web browser.
            ...
            return dedent(
                f"""
                <SYSTEM_CAPABILITY>
                * You are Apollos, a smart computer operating assistant. You help the users accomplish tasks using a computer.
