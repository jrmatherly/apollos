...
from apollos.processor.operator.operator_actions import DragAction, OperatorAction, Point
from apollos.processor.operator.operator_environment_base import (
    Environment,
    EnvState,
    EnvStepResult,
)
from apollos.utils.helpers import convert_image_to_webp
...
class ComputerEnvironment(Environment):
    def __init__(
        ...
        docker_container_name: str = "apollos-computer",
    ):
