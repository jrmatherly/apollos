...
from apollos.database.models import ChatMessageModel
from apollos.processor.conversation.openai.gpt import converse_openai
...
from apollos.utils.helpers import ConversationCommand
...
@pytest.mark.anyio
@pytest.mark.django_db(transaction=True)
async def test_websearch_apollos_website_for_info_about_apollos(chat_client, default_user2):
    # Arrange
