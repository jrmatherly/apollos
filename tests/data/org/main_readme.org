...
** Use
*** *Apollos via Emacs*  [[https://github.com/jrmatherly/apollos][link to apollos website]]  :@EMACS:CLIENT_1:APOLLOS:
     - [[https://github.com/jrmatherly/apollos/tree/master/interface/emacs#installation][Install]] [[./interface/emacs/apollos.el][apollos.el]]
     - Run ~M-x apollos <user-query>~ or Call ~C-c C-s~
...
*** *Apollos via API*
     ...
     - [[http://localhost:42110/docs][Apollos API Docs]]

*** *Call Apollos via Python Script Directly*
     #+begin_src shell
